...
update enquete set cod_sco = '_1' where cod_sco = '1a';
update enquete set cod_sco = '_2' where cod_sco = '2a';
update enquete set cod_sco = '_3' where cod_sco = '3a';
update enquete set cod_sco = '_4' where cod_sco = '4a';
update enquete set cod_sco = '_5' where cod_sco = '5a';
update enquete set cod_sco = '_6' where cod_sco = '6a+';
