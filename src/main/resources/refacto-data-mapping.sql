...
update enquete set cod_sco = '_1' where lower(cod_sco) = lower('x1');
update enquete set cod_sco = '_2' where lower(cod_sco) = lower('x2');
update enquete set cod_sco = '_3' where lower(cod_sco) = lower('x3');
update enquete set cod_sco = '_4' where lower(cod_sco) = lower('x4');
update enquete set cod_sco = '_5' where lower(cod_sco) = lower('x5');
update enquete set cod_sco = '_6' where lower(cod_sco) = lower('x6+');
...
update enquete set cod_fmt = 'PARA' where lower(cod_fmt) = lower('afp');
update enquete set cod_fmt = 'PARA' where lower(cod_fmt) = lower('aup');
update enquete set cod_fmt = 'PARA' where lower(cod_fmt) = lower('pfa');
update enquete set cod_fmt = 'MEDI' where lower(cod_fmt) = lower('pha');
