...
public interface DossierRepository extends JpaRepository<Dossier, Long> {
    ...
    @Query("select d.id as id, i.numEtu as numEtu, i.firstName as firstName, i.name as name, i.dateOfBirth as dateOfBirth, i.civilite as civilite, " +
            "d.type as type, d.statusDossier as statusDossier, i.id as individuId " +
